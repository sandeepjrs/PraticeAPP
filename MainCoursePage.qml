...
//                    anchors.centerIn: parent
                    spacing: 1
                    Rectangle{height: heightForOneCell-heightForOneCell*.86;width: widthForOneCell;Text{text: mainCourseId;font.pixelSize: 20;anchors.centerIn: parent } color: "transparent"}
                    Rectangle{height: heightForOneCell-heightForOneCell*.60;width: widthForOneCell;
                        Text{text: "<b>"+mainCourseItem;font.pixelSize: 35;anchors.centerIn: parent;
                        ...
                        color: "transparent"}
                    Rectangle{height: heightForOneCell-heightForOneCell*.86;width: widthForOneCell;Text{text: "Rs. <b>"+mainCoursePrice;font.pixelSize: 25;anchors.centerIn: parent } color: "transparent"}
                    anchors.centerIn: parent
                }
                 anchors.fill: parent
                onClicked: {
